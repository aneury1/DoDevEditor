...
JsonStyledTextCtrl::JsonStyledTextCtrl(wxWindow *parent, wxWindowID id) : wxStyledTextCtrl(parent, id)
{
...
void JsonStyledTextCtrl::OpenFile(const wxString &path)
{
...
void JsonStyledTextCtrl::ApplyTheme(const Json::Value &theme)
{
    ApplyBase(theme);
    ApplyLexer(theme);
    ApplyKeywords(theme);
...
void JsonStyledTextCtrl::ApplyDarkTheme()
{
    // =========================
...
wxColour JsonStyledTextCtrl::ToColor(const Json::Value &arr)
{
...
void JsonStyledTextCtrl::ApplyBase(const Json::Value &theme)
{
...
void JsonStyledTextCtrl::ApplyLexer(const Json::Value &theme)
{
...
void JsonStyledTextCtrl::ApplyKeywords(const Json::Value &theme)
{
...
void JsonStyledTextCtrl::ApplyStyles(const Json::Value &theme)
{
...
void JsonStyledTextCtrl::ApplyLineNumbers(const Json::Value &theme)
{
...
void JsonStyledTextCtrl::ApplyCaret(const Json::Value &theme)
{
...
void JsonStyledTextCtrl::ApplySelection(const Json::Value &theme)
{
...
void JsonStyledTextCtrl::OnCharAdded(wxStyledTextEvent &event)
{
...
wxString JsonStyledTextCtrl::GetSuggestions(const wxString &prefix)
{
    wxArrayString words = {
...
void JsonStyledTextCtrl::ShowAutocomplete()
{
    wxString words = "int float double if else for while return class struct";
    AutoCompShow(0, words);
}
void JsonStyledTextCtrl::OnKeyDown(wxKeyEvent &event)
{
